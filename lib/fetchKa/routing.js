  ...
  exports.FetchKaRouting = FetchKaRouting = (function() {
    ...
    InnerBuilder = (function() {
      ...
      InnerBuilder.prototype.build = function() {
        var routing;
        routing = new FetchKaRouting(this._topic);
    ...
    FetchKaRouting.Builder = InnerBuilder;

    function FetchKaRouting(topic) {
      this.topic = topic;
      this.level = [];
    }
    ...
    FetchKaRouting.prototype.addRouting = function(route) {
      ...
      for (_i = 0, _len = subLevel.length; _i < _len; _i++) {
        s = subLevel[_i];
        _results.push(this.next.push(new FetchKaRouting.Builder(this.topic).routing(s).build()));
      }
      return _results;
    };

    FetchKaRouting.prototype.onMessage = function(message) {
      var l, n, _i, _j, _len, _len1, _ref, _ref1, _results;
      LOG.trace(message);
      _ref = this.level;

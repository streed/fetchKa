...
(function() {
  ...
  exports.FetchKaHandler = FetchKaHandler = (function() {
    ...
    InnerBuilder = (function() {
      ...
      InnerBuilder.prototype.setName = function(_name) {
        this._name = _name;
        return this;
      };
      ...
      InnerBuilder.prototype.build = function() {
        return new FetchKaHandler(this._topic, this._onMessage, this._onError, this.name, this.counter);
      };
    ...
    function FetchKaHandler(topic, onMessage, onError, name, counter) {
      this.topic = topic;

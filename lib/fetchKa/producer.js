...
(function() {
  ...
  exports.FetchKaProducer = FetchKaProducer = (function() {
    ...
    InnerBuilder = (function() {
      ...
      InnerBuilder.prototype.setEncoder = function(_encoder) {
    ...
    function FetchKaProducer(_client, _topics, _encoder) {
        ...
        messages = (function() {
          ...
          for (_i = 0, _len = messages.length; _i < _len; _i++) {
            ...
            if (_ref = message.topic, __indexOf.call(this._topics, _ref) >= 0) {
              _results.push({
                topic: message.topic,
                messages: this._encoder(message.messages)
              });
            }
          }
          return _results;
